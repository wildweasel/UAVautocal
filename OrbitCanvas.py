...
class OrbitCanvas(OpenCVCanvas):
	...
	def calcFlightPath(self):
		...
		offsetY = self.rawOverhead.shape[1]/2 - int(self.centerY.get())
		...
		for pos in self.flightPath:
			cv2.circle(self.overheadFlightPath, pos, 2, (0, 255, 0), -1)
	...
	def mapFlightPath(self, currentPosition):
		...
		cv2.line(currentOverheadPath, (pos[0]-5,pos[1]-5), (pos[0]+5,pos[1]+5), (255,0,0), 3)
		cv2.line(currentOverheadPath, (pos[0]-5,pos[1]+5), (pos[0]+5,pos[1]-5), (255,0,0), 3)
